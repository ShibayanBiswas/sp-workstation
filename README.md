...
iframe access to desk modules (Primary SP, Dynamic Probability Calculator,
Gift City AIF Backtester, Gift City AIF Forwardtester, Options Lab, Option
Chain Archive).
...
- Module navigation: Primary SP Dashboard, Dynamic Probability Calculator,
  Gift City AIF Backtester, Gift City AIF Forwardtester, Options Lab,
