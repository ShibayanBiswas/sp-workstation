...
export function DashboardHome({ name }: Props) {
  return (
    <MarketsProvider>
      <div className="terminal-shell terminal-shell-alive min-h-full">
        <div className="terminal-canvas space-y-4 px-3 pt-3 pb-0 sm:space-y-5 sm:px-5 sm:pt-5 md:space-y-6 md:px-8 md:pt-8">
          ...
          <footer className="animate-rise-delay-4 border-t border-[var(--border)] pt-2 pb-0 text-center text-[10px] tracking-[0.2em] text-[var(--fg-subtle)]">
